...
<head>
    ...
    <title>Una carta mas para mi amado...</title>
    <style>
        body {
            display: flex;
            ...
            align-items: center;
            min-height: 100vh;
            background: linear-gradient(135deg, #f5e1e6, #e6d5f7);
        ...
        .carta {
            ...
            border-image: linear-gradient(45deg, #ff6f91, #ffccd5) 1;
            animation: fadeIn 1s ease-in;
        }

        .carta::before, .carta::after,
        .carta .decor1, .carta .decor2 {
            content: '';
            position: absolute;
            width: 50px;
            height: 50px;
